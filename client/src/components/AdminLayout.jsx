...
const VendorListing = [
  ...
  { name: 'Loan Categories', url: '/admin-loans', icon: <AccountBalanceIcon /> },
  { name: 'Loan Applications', url: '/admin-dashboard', icon: <CreditScoreIcon /> },
...
function AdminLayout(props) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between' , backgroundColor : "green"}} >
